...
- MAC 을 이용한 유사도 평가
  - 두 이미지로부터 얻은 MAC을 $$cos-similarity$$ 을 통해 유사도를 계산한다.
  - 보통은 맨 마지막 FCN을 사용.
- 실제 얻어진 결과를 보자.
...
![figure.4](https://norman3.github.io/papers/images/deepimgir/f04.png)
...
![figure.13](https://norman3.github.io/papers/images/deepimgir/f13.png)
