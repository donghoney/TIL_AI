...
if __name__ == '__main__':
    ...
    features_training_data = [
        ...
        'bol_upper_ratio','bol_lower_ratio'
    ]
    ...
    if trainable==True:
        ...
        policy_learner = PolicyLearner(
            ...
            min_trading_unit=1, max_trading_unit=5, delayed_reward_threshold=.05, lr=.001)
        policy_learner.fit(balance=10000000, num_epoches=2000,
